...
predicted_sql_path='/home/linhx/workspace/kouan/mini_dev/exp_result/p1subv2/predict_dev_qwen3.6-35b-a3b_SQLite.json' # Replace with your predict sql json path
...
case $sql_dialect in
  "SQLite")
    ...
    diff_json_path="/home/linhx/workspace/kouan/datasets/bird/dev/p1_v2.jsonl"
    # ground_truth_path="../sqlite/mini_dev_sqlite_gold.sql"
    ground_truth_path="/home/linhx/workspace/kouan/datasets/bird/dev/p1_v2_gold.sql"
    ;;
  "PostgreSQL")
