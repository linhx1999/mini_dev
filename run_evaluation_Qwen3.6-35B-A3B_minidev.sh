...
db_root_path='../datasets/bird/minidev/MINIDEV/dev_databases/'
num_cpus=16
meta_time_out=30.0
# DO NOT CHANGE THIS
...
predicted_sql_path='exp_result/turbo_output/predict_mini_dev_Qwen3.6-35B-A3B_cot_SQLite.json' # Replace with your predict sql json path
...
case $sql_dialect in
  "SQLite")
    ...
    diff_json_path="/root/autodl-tmp/workspace/kouan/datasets/bird/minidev/MINIDEV/mini_dev_sqlite.jsonl"
    # ground_truth_path="../sqlite/mini_dev_sqlite_gold.sql"
    ground_truth_path="/root/autodl-tmp/workspace/kouan/datasets/bird/minidev/MINIDEV/mini_dev_sqlite_gold.sql"
    ;;
  "PostgreSQL")
