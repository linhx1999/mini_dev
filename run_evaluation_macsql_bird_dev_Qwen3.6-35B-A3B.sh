...
predicted_sql_path='/home/linhx/workspace/kouan/mini_dev/exp_result/macsql_bird_dev_Qwen3.6-35B-A3B/macsql_bird_dev_Qwen3.6-35B-A3B_output_bird_converted.json'
...
case $sql_dialect in
  "SQLite")
    ...
    diff_json_path="/home/linhx/workspace/kouan/datasets/bird/dev/dev.jsonl"
    # ground_truth_path="../sqlite/mini_dev_sqlite_gold.sql"
    ground_truth_path="/home/linhx/workspace/kouan/datasets/bird/dev/dev.sql"
    ;;
  "PostgreSQL")
