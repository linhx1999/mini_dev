...
eval_path='/home/linhx/workspace/kouan/datasets/bird/dev/p1_v2.json'
db_root_path='/home/linhx/workspace/kouan/datasets/bird/dev/dev_databases/'
use_knowledge='False'
mode='dev'  # dev, train, mini_dev
cot='False'
sql_dialect='SQLite'
data_output_path='./exp_result/p1subv2/'
